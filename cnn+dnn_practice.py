...
W_cnn3 = tf.Variable(tf.random_normal([3,3,64,128], stddev=0.01))
L3 = tf.nn.conv2d(L2, W_cnn3, strides=[1,1,1,1], padding='SAME')
L3 = tf.nn.relu(L3)
...
W1 = tf.get_variable("W1", shape=[128*4*4, 512],
