...
X_train = tf.placeholder(tf.float32, [None, 100])
...
W1 = tf.get_variable("W1", shape=[100, 300],
...
W3 = tf.get_variable("W3", shape=[300, 500],
                     initializer=tf.contrib.layers.xavier_initializer())
b3 = tf.Variable(tf.random_normal([500]))

L3 = tf.nn.relu(tf.matmul(L2, W3) + b3)

W4 = tf.get_variable("W4", shape=[500, 300],
                     initializer=tf.contrib.layers.xavier_initializer())
b4 = tf.Variable(tf.random_normal([300]))

L4 = tf.nn.relu(tf.matmul(L3, W4) + b4)

W5 = tf.get_variable("W5", shape=[300, 10],
                     initializer=tf.contrib.layers.xavier_initializer())
